...
class FallingForever:
    def __init__(self):

        self._audio = audiobusio. I2SOut(bit_clock=i2s_bclk, word_select=i2s_wsel, data=i2s_data)

        # start code by todbot
        self._synth = synthio.Synthesizer(sample_rate = 28 * 1024)
